...
options_sgp$r2_ar1_sign1 <- list3(
  t_cut = 1,
  fun = unconditional_sgp(
    create_sgp$ar,
    list(
...
options_sgp$r2_ar1_sign2 <- list3(
  t_cut = 1,
  fun = unconditional_sgp(
    create_sgp$ar,
    list(
