...
#'
#' @return [`function`] Markov regime generator function.
create_rgp$markov <- function(probs) {
...
#'
#' @value [`function`] Structural break regime generator function.
create_rgp$sbreak <- function(breaks) {
...
#'
#' @value [`function`] Threshold regime generator function.
create_rgp$threshold <- function(breaks, g = \(x) x) {
...
#'
#' @value [`function`] Smooth threshold regime generator function.
create_rgp$smooth_threshold <- function(breaks, g) {
  walk(list(breaks, g), force)
